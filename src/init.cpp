...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Litecoin Silver bootstrap mode. Allows LTS client to connect to Bitcoin p2p network to download blockahin history."));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/litecoinsilver/ltcsilver>";
    const std::string URL_WEBSITE = "<https://ltcsilver.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Litecoin Silver version %s\n", FormatFullVersion());
}
